...
import type { InitProgressCallback, LogLevel, LogitProcessor } from './types';
import {
  DependencyError,
...
export const prebuiltAppConfig: AppConfig = {
  ...
  model_list: [
    // Llama-3.2
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3.2-1B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3.2-1B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    // },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3.2-1B-Instruct-q0f16-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3.2-3B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    // Llama-3.1
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3_1-8B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3_1-8B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    // },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2-7B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: false,
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2-7B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: false,
    ...
    // Hermes-3 and Hermes-2
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3-8B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3-8B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
    ...
    // Phi3.5-mini-instruct
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Phi-3.5-mini-instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Phi-3.5-mini-instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
    ...
    // SmolLM2
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-1.7B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-1.7B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
...

    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-360M-Instruct-q0f16-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-360M-Instruct-q0f32-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-360M-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-360M-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-135M-Instruct-q0f16-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/SmolLM2-135M-Instruct-q0f32-ctx4k_cs1k-webgpu.wasm',
    ...
    // Gemma2-2b-jpn
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/gemma-2-2b-jpn-it-q4f16_1-ctx4k_cs1k-webgpu.wasm',
      vram_required_MB: 1895.3,
      low_resource_required: true,
      required_features: ['shader-f16'],
      overrides: {
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/gemma-2-2b-jpn-it-q4f32_1-ctx4k_cs1k-webgpu.wasm',
      vram_required_MB: 2508.75,
      low_resource_required: true,
      overrides: {
        context_window_size: 4096,
    ...
    // Qwen-2
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2-0.5B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: true,
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2-0.5B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: true,
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2-0.5B-Instruct-q0f16-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: true,
    ...
    // },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2-1.5B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: true,
      vram_required_MB: 1629.75,
      overrides: {
        context_window_size: 4096,
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2.5-3B-Instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: true,
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Qwen2.5-3B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
      low_resource_required: true,
    ...
    // StableLM-zephyr-1.6B
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/stablelm-2-zephyr-1_6b-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/stablelm-2-zephyr-1_6b-q4f32_1-ctx4k_cs1k-webgpu.wasm',
    ...
    // Llama-3.1 70B
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3_1-70B-Instruct-q3f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-3-70B-Instruct-q3f16_1-ctx4k_cs1k-webgpu.wasm',
      vram_required_MB: 31153.13,
      low_resource_required: false,
      overrides: {
        context_window_size: 4096,
    ...
    // Phi3-mini-instruct
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Phi-3-mini-4k-instruct-q4f16_1-ctx4k_cs1k-webgpu.wasm',
      vram_required_MB: 3672.07,
      low_resource_required: false,
      overrides: {
        context_window_size: 4096,
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Phi-3-mini-4k-instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm',
      vram_required_MB: 5483.12,
      low_resource_required: false,
      overrides: {
        context_window_size: 4096,
    ...
    // Llama-2
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-2-7b-chat-hf-q4f32_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-2-7b-chat-hf-q4f16_1-ctx4k_cs1k-webgpu.wasm',
    ...
    },
    {
      ...
      model_lib:
        modelLibURLPrefix + modelVersion + '/Llama-2-13b-chat-hf-q4f16_1-ctx4k_cs1k-webgpu.wasm',
